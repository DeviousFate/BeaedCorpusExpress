...
The Business must recieve completed order invoices with design selections in PDF format directly to Client. (Structure)
...
User must recieve a finalized proof of product prior to payment portal. Also store in user account information and send to user account email.

The files sent to the Business must be translateable into PDF.
